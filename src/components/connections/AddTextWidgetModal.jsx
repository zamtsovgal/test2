...
export default function AddTextWidgetModal({ isOpen, onClose, onSave }) {
    ...
    const footer = (
        <>
            ...
            <Button type="submit" form="text-widget-form" className="bg-purple-600 hover:bg-purple-700">Add Text</Button>
        </>
    );
    ...
    return (
        <Modal
            ...
            description="Add custom text anywhere on your dashboard."
            footer={footer}
            size="lg"
        >
            <form id="text-widget-form" onSubmit={handleSubmit} className="space-y-6">
                <div>
